...
export default function AboutUs() {
  ...
  return (
    ...
    <div className="position-relative">
      <RightGradient />
      <div id="about" className="container mt-lg-5 mb-lg-3 mt-md-3 mt-2 mx-lg-auto ms-md-3 ms-2 pb-5 card-bg rounded-5 row justify-content-center gap-lg-5 fade-in">
        <div className="col-lg-6 transparent-background">
          <img className="img-fluid pulsing-element" src={aboutUsImg} alt='gif' />
        </div>
        <div className="col-lg-5 text-light mt-lg-5 mt-md-3 mt-2 pe-lg-5 text-start">
          <h1 className="display-3 fw-semibold heading-font">About us</h1>
          ...
          <div className="mt-3">
            <button className='btn button btn-lg rounded-pill px-4 py-2' style={{ backgroundColor: 'rgb(194,5,215)' }}>Read more</button>
          </div>
        </div>
      </div>
      </div>
