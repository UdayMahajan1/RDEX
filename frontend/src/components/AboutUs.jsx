    ...
    <>
      <div className="position-relative about-us-margin">
        ...
        <div id="about" className="container-fluid pb-lg-5 p-sm-5 p-3 ms-0 mt-lg-4 card-bg rounded-5 row justify-content-center gap-lg-5 fade-in">
          <div className="d-none d-lg-block col-lg-6 col-xl-4 transparent-background">
            <div className='d-flex justify-content-center'>
              <img className="img-fluid pulsing-element" src={aboutUsImg} alt='gif' />
            </div>
          </div>
          <div className="col-lg-5 col-xl-7 col text-light mt-lg-5 mt-md-3 mt-2 pe-lg-5 text-lg-start position-relative">
            ...
            <div className="row mt-lg-3 mt-sm-5 mt-3 mb-3 justify-content-lg-start justify-content-center position-absolute bottom-0 start-0 end-0">
              <button className='col-sm-5 col-10 btn button btn-lg rounded-pill px-4 py-2 mx-xl-auto' >Read more</button>
            </div>
          </div>
        </div>
      </div>
