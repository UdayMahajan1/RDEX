...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="navbar navbar-expand-md bg-Dark py-xl-2 py-sm-3 py-lg-1 py-md-2 nav-padding sticky-md-top">
      <div className="container-fluid">
        ...
        <a href='#'><img src={originalLogo} className="navbar-icon px-lg-3 px-md-0 px-sm-1 rounded-circle"
          alt='..' /></a>
        <button className="navbar-toggler border-2 border-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup"
