...
export default function FlexProducts({ img, title, desc }) {
  return (
    <div className="container-fluid row mt-lg-5 mt-md-0 mt-sm-3 mt-3 pt-md-5 justify-content-md-between justify-content-xl-center gap-3 text-white position-relative mx-lg-auto">
      <LeftGradient />
